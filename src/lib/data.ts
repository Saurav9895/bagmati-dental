...
export const mockPatients: Patient[] = [
  { id: 'DF001', name: 'John Doe', dob: '1985-05-20', email: 'john.doe@example.com', phone: '123-456-7890', status: 'Active', lastVisit: '2024-06-15' },
  { id: 'DF002', name: 'Jane Smith', dob: '1992-08-12', email: 'jane.smith@example.com', phone: '234-567-8901', status: 'Active', lastVisit: '2024-07-01' },
  { id: 'DF003', name: 'Michael Johnson', dob: '1978-11-30', email: 'michael.j@example.com', phone: '345-678-9012', status: 'Active', lastVisit: '2024-05-10' },
  { id: 'DF004', name: 'Emily Davis', dob: '2001-02-18', email: 'emily.davis@example.com', phone: '456-789-0123', status: 'Inactive', lastVisit: '2023-01-22' },
  { id: 'DF005', name: 'Chris Wilson', dob: '1995-07-25', email: 'chris.wilson@example.com', phone: '567-890-1234', status: 'Active', lastVisit: '2024-06-28' },
];
